...
public class PortugueseAlph extends ActionBarActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ttsObject = new TextToSpeech(PortugueseAlph.this, new TextToSpeech.OnInitListener() {
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent logout = new Intent(PortugueseAlph.this, MainActivity.class);
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent profile1 = new Intent(PortugueseAlph.this, profile.class);
        ...
        homepage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent homepage = new Intent(PortugueseAlph.this, ChoseLanguage.class);
