...
public class Spanish extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        welcome = (TextView) findViewById(R.id.welcome10);
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Spanish.this, MainActivity.class);
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent profile1 = new Intent(Spanish.this, profile.class);
    ...
    public void getData() {
        ...
        try {
            ...
            HttpPost httppost = new HttpPost(
                    "http://lingo.hostei.com/getquiz_span.php");
        ...
        homepage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent homepage = new Intent(Spanish.this, ChoseLanguage.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_german, menu);
        return true;
    }
