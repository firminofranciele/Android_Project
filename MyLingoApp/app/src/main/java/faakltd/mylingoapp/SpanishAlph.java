...
public class SpanishAlph extends ActionBarActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spanish_alph);

        ttsObject = new TextToSpeech(SpanishAlph.this, new TextToSpeech.OnInitListener() {
        ...
        welcome = (TextView) findViewById(R.id.welcome16);
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent profile1 = new Intent(SpanishAlph.this, profile.class);
        ...
        homepage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent homepage = new Intent(SpanishAlph.this, ChoseLanguage.class);
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent logout = new Intent(SpanishAlph.this, MainActivity.class);
    ...
    public void getData() {
        ...
        try {
            ...
            HttpPost httppost = new HttpPost(
                    "http://lingo.hostei.com/getalpha_span.php");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_spanish_alph, menu);
        return true;
    }
