...
public class RussianCP extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_russian_cp);
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(RussianCP.this, MainActivity.class);
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent profile1 = new Intent(RussianCP.this, profile.class);
        ...
        homepage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent homepage = new Intent(RussianCP.this, ChoseLanguage.class);
    ...
    public void getData() {
        ...
        try {
            ...
            HttpPost httppost = new HttpPost(
                    "http://lingo.hostei.com/getcommonRussian.php");
