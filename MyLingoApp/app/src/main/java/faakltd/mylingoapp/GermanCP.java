...
public class GermanCP extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_german_cp);
        ...
        welcome = (TextView) findViewById(welcome8);
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(GermanCP.this, MainActivity.class);
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent profile1 = new Intent(GermanCP.this, profile.class);
        ...
        homepage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent homepage = new Intent(GermanCP.this, ChoseLanguage.class);
    ...
    public void getData() {
        ...
        try {
            ...
            HttpPost httppost = new HttpPost(
                    "http://lingo.hostei.com/getcommonGerman.php");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_german_c, menu);
        return true;
    }
